...
describe('linkBuilder', () => {
  ...
  describe('horizonUrlToExplorerLink()', () => {
    it('converts a simple horizon link to a endpoint explorer link', () => {
      expect(linkBuilder.horizonUrlToExplorerLink('https://horizon-testnet.kininfrastructure.com/ledgers/1173'))
    ...
    it('converts a templated horizon link to a endpoint explorer link', () => {
      expect(linkBuilder.horizonUrlToExplorerLink('https://horizon-testnet.kininfrastructure.com/ledgers/1173/transactions{?cursor,limit,order}'))
